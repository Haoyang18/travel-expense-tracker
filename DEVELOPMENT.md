...
```bash
git remote add encore encore://travel-expense-tracker-6y92
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/travel-expense-tracker-6y92/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/travel-expense-tracker-6y92/settings/integrations/github)
